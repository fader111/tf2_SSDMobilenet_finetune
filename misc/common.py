...
category_index = {1: {'id': 1, 'name': 'person'}, 2: {'id': 2, 'name': 'bicycle'}, 3: {'id': 3, 'name': 'car'}, 4: {'id': 4, 'name': 'motorcycle'}, \
  5: {'id': 5, 'name': 'airplane'}, 6: {'id': 6, 'name': 'bus'}, 7: {'id': 7, 'name': 'train'}, 8: {'id': 8, 'name': 'truck'}, 9: {'id': 9, 'name': 'boat'}, \
  10: {'id': 10, 'name': 'traffic light'}, 11: {'id': 11, 'name': 'fire hydrant'}, 13: {'id': 13, 'name': 'stop sign'}, 14: {'id': 14, 'name': 'parking meter'}, \
  15: {'id': 15, 'name': 'bench'}}
...
def visualize_boxes_and_labels_on_image_array(
  ...
  for i in range(boxes.shape[0]):
    ...
    if scores is None or scores[i] > min_score_thresh:
      # print (f'!!!!scores index = {scores[i]}, index-{i}')
