...
# image_path = IMAGES_FOR_TEST[selected_image]th = IMAGES_FOR_TEST[selected_image]
image_path = 'src_pictures/treet_car_ppl.jpg'
image_path = 'src_pictures/2.jpg'
...
# cv2.imshow("image_np[0]", image_np[0])
# plt.show()
# cv2.waitKey(0)
...
matplotlib.use("TkAgg") # otherwise it conflicts with opencv
print (f'matplotlib backend 2 is {plt.get_backend()}')
# plt.figure(figsize=(24,32))
plt.imshow(image_np_with_mask[0])
plt.show()
# cv2.imshow('image_np_with_mask[0]', image_np_with_mask[0])
# cv2.waitKey()
